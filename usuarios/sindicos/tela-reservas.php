...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../css/stylereservasSINDICO.css">
    ...
    <div id="content-wrapper">
        ...
        <div id="content">
            <div class="input-container">
                <label for="titulo1" class="label-cabecalho label-titulo1">Reservas</label>
            </div>
        </div>
        ...
        <div id="content2">
            <span class="label-observacao">Acesse as reserva solicitdas pelos moradores e decida se os eventos em
                questão serão marcados.</span>
        </div>
