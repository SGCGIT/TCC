        ...
        <div id="content">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="input-container">
                    <label for="titulo" class="label-cabecalho label-titulo">Reclamação realizada com sucesso!</label>
                    <label for="mensagem" class="label-mensagem label-prazo1">Agradecemos por sua reclamação, ela já
                        está em análise!</label>
                    <div id="content-prazo">
                        <label for="mensagem" class="label-prazo label-prazo1">- Prazo de visualização para reclamações
                            urgentes: 1 dia.</label>
                        <label for="mensagem" class="label-prazo label-prazo2">- Prazo de visualização para reclamações
                            importantes: 5 dia.</label>
                    </div>
