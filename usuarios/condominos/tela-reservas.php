...
<body>
    ...
    <div id="content-wrapper">
        ...
        <div id="content2">
            <span class="label-observacao">Observação: o envio da solicitação de reserva não garante que o espaço
                escolhido será reservado. Aguarde a devolutiva do síndico sobre sua solicitação para mais
                informações.</span>
        </div>
