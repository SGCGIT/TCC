...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../css/stylesucessosugestoes.css">
</head>
...
<body>
        ...
        <div id="content">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="input-container">
                    <label for="titulo" class="label-cabecalho label-titulo">Sugestão realizada com sucesso!</label>
                    <label for="mensagem" class="label-mensagem label-prazo1">Agradecemos pela sua sugestão, ela já está
                        em análise!</label>
                    <div id="content-agradecimento">
                        <label for="mensagem" class="label-agradecimento">Com base nela, poderemos apurar os desejos de
                            nossos moradores e tornar nosso condomínio ainda melhor. Sua participação é fundamental para
                            o constante aperfeiçoamento do nosso espaço. </label>
                    </div>
    ...
    <script>
        ...
        document.getElementById('btnvoltar').addEventListener('click', function () {
            ...
            window.location.href = './tela-sugestoes.php';
        });
    </script>
</body>
