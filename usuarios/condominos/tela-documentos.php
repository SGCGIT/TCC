...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../css/styledocumentos.css">
</head>
...
<body>
    ...
    <div id="content-wrapper">
        ...
        <div id="content2">
            <span class="label-observacao">Aqui você pode conferir todos os documentos referentes ao seu condomínio,
                enviados pelo seu síndico.</span>
        </div>
